...
execute if score blueportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{blue:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:blue_wool replace short_grass
...
execute if score orangeportal data matches 1 at @e[type=minecraft:trident,nbt={Trident:{tag:{orange:1}}}] run fill ~2 ~4 ~ ~-1 ~ ~ minecraft:orange_wool replace short_grass
